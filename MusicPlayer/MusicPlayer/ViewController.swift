...
//        self.addViewsWithCode()
    ...
    // MARK: - Methods
    // MARK: Custom Method
    func initializePlayer() { //player 초기화
    ...
    func updateTimeLabelText(time: TimeInterval) { //레이블 매 초 마다 업데이트
    ...
    func makeAndFireTimer() { //타이머 생성하고 수행
